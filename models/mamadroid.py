...
def build_markov_feature_androidguard(CG, output_path=None):
    ...
    if output_path is not None:
        ...
        logging.critical(blue('Successfully save the markov feature in: {}'.format(output_path)))
...
def get_mamadroid_feature(apk_path, output_path=None, graph_path=None):
    ...
    try:
        ...
        logging.critical(green("Successfully extract APK: {}".format(os.path.basename(apk_path))))
    except:
